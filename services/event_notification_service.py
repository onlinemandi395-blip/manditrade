...
class EventNotificationService:
    ...
    def _resolve_recipients(self, event_type: str, payload: dict[str, Any]) -> list[dict[str, str]]:
        ...
        if event_type in {"PRODUCT_APPROVAL_REQUESTED", "PAYMENT_DISPUTE", "FAILED_WORKFLOW", "SYSTEM_HEALTH_ALERT", "COMMISSION_DUE", "MANUFACTURER_CREATED", "MANUFACTURER_UPDATED", "MAHAJAN_INVITED", "MAHAJAN_ONBOARDED", "MANDIPLACE_ORDER_CREATED", "SUPPLIER_QUOTED", "PACKAGING_SELECTED", "ORDER_DISPATCHED", "ORDER_DELIVERED", "PAYMENT_OVERDUE", "DISPUTE_CREATED", "DISPUTE_RESOLVED", "INVOICE_GENERATED"}:
